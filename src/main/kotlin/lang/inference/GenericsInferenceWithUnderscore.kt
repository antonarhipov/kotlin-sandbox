...
fun main() {
    // T is inferred to String because of inference.SomeImplementation derives from inference.SomeClass<String>
    val s = Runner.run<SomeImplementation, _>()
    assert(s == "Test")

    // T is inferred to Int because of inference.OtherImplementation derives from inference.SomeClass<Int>
